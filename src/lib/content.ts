...
export const SUBJECTS: Subject[] = [
  {
    ...
    icon: "math",
    playlists: [
      pl("math-algebra", "math-algebra", "Algebra", "Variables, expressions, identities and equations.", [
      ...
      pl("math-matrices", "math-matrices", "Matrices", "Rows, columns, addition, multiplication, determinants."),
      pl("math-trig", "math-trig", "Trigonometry", "Sin, cos, tan and their applications."),
      pl("math-quadratic", "math-quadratic", "Quadratic Equations", "Roots, discriminant, factoring and the quadratic formula.", [
      ...
      pl("math-ap", "math-ap", "Arithmetic Progressions", "Common difference, nth term, and sum formulas."),
      pl("math-geometry", "math-geometry", "Geometry", "Triangles, circles, similarity and theorems."),
    ],
  },
  {
    id: "biology",
    ...
    icon: "science",
    playlists: [
      pl("bio-life", "bio-life", "Life Processes", "Nutrition, respiration, transport and excretion.", [
      ...
      pl("bio-eye", "bio-eye", "Human Eye", "Structure, vision, defects and corrections."),
      pl("bio-control", "bio-control", "Control & Coordination", "Nervous system, reflexes, hormones."),
      pl("bio-reproduction", "bio-reproduction", "Reproduction", "Asexual and sexual reproduction in living things."),
      pl("bio-heredity", "bio-heredity", "Heredity", "Genes, chromosomes and inheritance."),
      pl("bio-environment", "bio-environment", "Environment", "Ecosystems, food chains and conservation."),
    ],
  },
  {
    id: "chemistry",
    ...
    icon: "science",
    playlists: [
      pl("chem-reactions", "chem-reactions", "Chemical Reactions", "Types, equations and balancing.", [
      ...
      pl("chem-acids", "chem-acids", "Acids & Bases", "pH, indicators and neutralisation.", [
      ...
      pl("chem-carbon", "chem-carbon", "Carbon Compounds", "Hydrocarbons, functional groups and isomers."),
      pl("chem-metals", "chem-metals", "Metals & Non-metals", "Properties, reactivity and uses."),
      pl("chem-periodic", "chem-periodic", "Periodic Table", "Groups, periods and trends."),
      pl("chem-env", "chem-env", "Environmental Chemistry", "Pollution, ozone and sustainability."),
    ],
  },
];
